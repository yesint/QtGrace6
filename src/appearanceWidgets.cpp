    ...
    ui(new Ui::frmSet_Appearance)
{
    ...
    cmbSymbStyle      = new LineStyleSelector(ui->lblSymbStyle, ui->cmbSymbStyleBox, this);
    ...
    cmbSymbFont       = new FontSelector(ui->lblSymbFont, ui->cmbSymbFontBtn, ui->cmbSymbFontBox, this);
    // Line tab
    fraDropLineProp   = ui->fraDropLineProp;
    cmbDropPattern    = new FillPatternSelector(ui->lblDropPattern, ui->cmbDropPatternBox, this);
    ...
    ledYOffs          = new stdLineEdit(ui->lblYOffs, ui->ledYOffsBox, false, this);
    // Error bars tab
    ...
    spnMaxLength      = new LineWidthSelector(ui->lblMaxLength, ui->spnMaxLengthBox, this);
    fraBarLine        = ui->fraBarLine;
    spnBarSize        = ui->spnBarSize;
    spnbarWidth       = new LineWidthSelector(ui->lblbarWidth, ui->spnbarWidthBox, this);
    cmbBarStyle       = new LineStyleSelector(ui->lblBarStyle, ui->cmbBarStyleBox, this);
    fraRiserLine      = ui->fraRiserLine;
    spnRiserWidth     = new LineWidthSelector(ui->lblRiserWidth, ui->spnRiserWidthBox, this);
    cmbRiserStyle     = new LineStyleSelector(ui->lblRiserStyle, ui->cmbRiserStyleBox, this);
